...
func paneFromInfo(info paneInfo) runtimeapi.Pane {
	return runtimeapi.Pane{ID: info.PaneID, TerminalID: info.TerminalID, WorkspaceID: info.WorkspaceID, Title: info.TerminalTitle, CWD: info.CWD, Agent: info.Agent, AgentSessionID: info.AgentSession.Value}
}
